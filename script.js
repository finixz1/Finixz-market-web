    ...
    const products = {
        ...
        "script sw grup": { desc: "ini adalah fitur yang memungkinkan pengguna membagikan foto, video, atau teks yang akan hilang secara otomatis dalam 24 jam. Tampilan lingkaran hijau yang Anda lihat di sekitar foto profil grup berfungsi sebagai indikator visual bahwa seseorang baru saja mengunggah status yang belum Anda lihat.", order: "Hubungi kami - pembayaran - pengiriman file - selesai", use: "media promosi\nDistribusi Informasi Massal\nOtomatisasi Komunikasi\nManajemen Komunitas\nEfisiensi Waktu"},
